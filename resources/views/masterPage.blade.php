...
<head>
  <!-- Declaro el viewport de media queries -->
    ...
    <title>{{ config('app.name', ' Music Store DH') }}</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
            ...
            <!-- <li class="headerli"> <span class="glyphicon glyphicon-log-in"></span> <a id="headera" href="logout">Logout</a> </li> -->


<!--             <li> <a href="perfilDeUsuario"> <span class="glyphicon glyphicon-user"></span> Perfil de  </a></li>
 -->
